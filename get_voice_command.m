...
% --------------- LIGAR DATABASE --------------------
	...
	lengths = [length(signal_pindi_ligar_2) length(audio_signal)];
	...
	lengths = [length(signal_pindi_ligar_3) length(audio_signal)];
	...
	% Pass to ligar 4
	signal_pindi_ligar_4 = wavread('pindi_ligar_4.wav');
	lengths = [length(signal_pindi_ligar_4) length(audio_signal)];
	signal_pindi_ligar_4 = signal_pindi_ligar_4(1:min(lengths));
	audio_signal_calc = audio_signal(1:min(lengths));
	cepstrum_pindi_ligar_4 = log(abs(fft(signal_pindi_ligar_4)));
	cepstrum_audio_signal = log(abs(fft(audio_signal_calc)));
	ligar_4 = corrcoef(cepstrum_pindi_ligar_4, cepstrum_audio_signal);
	ligar_4 = abs(ligar_4(1,2));

	% Pass to ligar 5
	signal_pindi_ligar_5 = wavread('pindi_ligar_5.wav');
	lengths = [length(signal_pindi_ligar_5) length(audio_signal)];
	signal_pindi_ligar_5 = signal_pindi_ligar_5(1:min(lengths));
	audio_signal_calc = audio_signal(1:min(lengths));
	cepstrum_pindi_ligar_5 = log(abs(fft(signal_pindi_ligar_5)));
	cepstrum_audio_signal = log(abs(fft(audio_signal_calc)));
	ligar_5 = corrcoef(cepstrum_pindi_ligar_5, cepstrum_audio_signal);
	ligar_5 = abs(ligar_5(1,2));

	% Pass to ligar 6
	signal_pindi_ligar_6 = wavread('pindi_ligar_6.wav');
	lengths = [length(signal_pindi_ligar_6) length(audio_signal)];
	signal_pindi_ligar_6 = signal_pindi_ligar_6(1:min(lengths));
	audio_signal_calc = audio_signal(1:min(lengths));
	cepstrum_pindi_ligar_6 = log(abs(fft(signal_pindi_ligar_6)));
	cepstrum_audio_signal = log(abs(fft(audio_signal_calc)));
	ligar_6 = corrcoef(cepstrum_pindi_ligar_6, cepstrum_audio_signal);
	ligar_6 = abs(ligar_6(1,2));
...
% ------------------- COMMANDS -------------------------
	commands_ligar = [ligar_1 ligar_2 ligar_3 ligar_4 ligar_5];
